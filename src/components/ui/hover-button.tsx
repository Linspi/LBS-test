...
interface HoverButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /** Couleur de départ du gradient des cercles (CSS color) */
  circleStart?: string
  /** Couleur de fin du gradient des cercles (CSS color) */
  circleEnd?: string
}

const HoverButton = React.forwardRef<HTMLButtonElement, HoverButtonProps>(
  ({ className, children, circleStart, circleEnd, style, ...props }, _ref) => {
    ...
    return (
      <button
        ...
        {...props}
        style={{
          "--circle-start": circleStart ?? "var(--tw-gradient-from, #5A7A9C)",
          "--circle-end":   circleEnd   ?? "var(--tw-gradient-to,   #A3C0DC)",
          ...style,
