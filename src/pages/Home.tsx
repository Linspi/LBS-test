      ...
      <section className="py-24 bg-card/30">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-6xl mx-auto mb-4">
            {SERVICE_BLOCKS.slice(0, 3).map((block, index) => (
              <FadeUp key={block.href} delay={index * 0.15}>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {COMMITMENTS.map((item, index) => (
              <FadeUp key={item.title} delay={index * 0.15}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {TESTIMONIALS.map((testimonial, i) => (
              <FadeUp key={i} delay={i * 0.15}>
                <div className="relative rounded-xl border border-border/50 bg-anthracite/50 p-8 flex flex-col h-full">
